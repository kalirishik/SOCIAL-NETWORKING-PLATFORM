...
import ProfileImg from "../../assets/VijayPic.jpg"
    ...
    <div className="notification-group">
      ...
      <div className="notification-section">
        <div className="notification-msg">
            <img src={img1} alt="" />
            <p>Hemanth kumar  liked <span className='noti-like'>your profile picture</span><small><br />10 mins ago</small></p>
        </div>
        ...
        <div className="notification-msg">
            <img src={img3} alt="" />
            <p>Kamal hassan liked <span className='noti-like'>your profile picture</span><br /><small>5h ago</small></p>
        </div>
